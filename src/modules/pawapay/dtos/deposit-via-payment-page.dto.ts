...
export class DepositViaPaymentPageDto {
  @ApiProperty({ example: '15', description: 'Amount to deposit' })
  amount: string;

  @ApiProperty({ example: 'ZMW', description: 'Currency code' })
  currency: string;

  @ApiProperty({ example: 'generated-uuid', description: 'Deposit ID (UUID)' })
  depositId: string;
